...
%%%%%%% Main Content %%%%%%%%%%%%%%%%%%%%%
	...
	\section{Related Work} \input{content/3_related_work}
	\section{Guidelines} \input{content/4_guidelines}
		\subsection{SPbPU Paper Format} \input{content/guidelines/spbpu_paper_format} 
		\subsection{SPbPU Structure} \input{content/guidelines/spbpu_structure}
	\section{Examples} \input{content/5_examples}
		\subsection{Figures} \input{content/examples/figures}
		\subsection{Tables} \input{content/examples/tables}
		\subsection{Equations} \input{content/examples/equations}
		\subsection{Algorithms} \input{content/examples/algorithms}
