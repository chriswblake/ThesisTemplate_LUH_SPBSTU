...
%%%%%%% Content %%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\mainmatter \pagestyle{mainmatter}
		...
		\chapter{Guidelines} \input{content/4_guidelines}
			...
			\section{SPbPU Binding} \input{content/guidelines/spbpu_binding}
		\chapter{Examples} \input{content/5_examples}
			...
			\section{Equations} \input{content/examples/equations} \clearpage
		...
		\chapter{Future Considerations} \input{content/9_future_considerations}
			\section{Topic Points} \input{content/future_considerations/topic_points} \clearpage
